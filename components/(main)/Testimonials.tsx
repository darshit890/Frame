      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <ScaleIn className="relative max-w-5xl mx-auto">
          ...
          <div className="bg-[#f8f8f8] rounded-[3rem] p-8 lg:p-16 relative mx-12 lg:mx-20">
            <div className="flex flex-col lg:flex-row gap-10 items-center lg:items-start">
              ...
              <div className="relative shrink-0">
                ...
                {/* Quote Badge */}
                <div className="absolute top-4 -right-2 bg-[#c4ff00] w-12 h-12 rounded-full flex items-center justify-center z-20 border-4 border-[#f8f8f8]">
          ...
          <button 
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 lg:translate-x-12 w-14 h-14 bg-[#c4ff00] rounded-full flex items-center justify-center text-black hover:scale-110 transition-transform z-30"
          >
             <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
