...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-[#111] pt-32 pb-20 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-6 mb-12 items-center">
            <StaggerContainer className="lg:col-span-9 space-y-8 max-w-4xl">
                ...
                <StaggerItem>
                  <div className="flex items-center gap-4">
                      <div className="w-12 h-[2px] bg-[#04d9ff]"></div>
                ...
                <StaggerItem>
                  <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold leading-[1.1] text-white tracking-tight">
                      ...
                      <span className="text-[#04d9ff]">Digital Excellence</span>
                  </h1>
                </StaggerItem>
            </StaggerContainer>
            ...
            <FadeIn delay={0.4} className="hidden lg:flex lg:col-span-3 justify-end relative w-32 h-32 shrink-0 mt-4 ml-auto">
                <Link href="/contact" className="relative w-32 h-32">
                     ...
                     <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-14 h-14 rounded-full bg-[#04d9ff] flex items-center justify-center transform -rotate-45 group hover:rotate-0 transition-transform duration-500 cursor-pointer shadow-[0_8px_24px_rgba(196,255,0,0.3)]">
        ...
        <div className="grid lg:grid-cols-12 gap-6 mb-16 items-center">
            ...
            <StaggerContainer className="lg:col-span-7 flex flex-wrap gap-3">
                {['Mobile Application Development', 'Website Development', 'UX/UI Design', 'Graphic Design', 'Digital Marketing'].map((tag) => (
                     <StaggerItem key={tag}>
                       <span className="block px-6 py-3 border-y-[0.2px] border-x-3 border-white/50 text-white text-sm rounded-full hover:border-[#04d9ff] hover:text-[#04d9ff] transition-all duration-300 cursor-default">
                          {tag}
                       </span>
                     </StaggerItem>
                ))}
        ...
        <div className="grid lg:grid-cols-12 gap-6 mb-20">
            ...
            <ScaleIn delay={0.2} className="lg:col-span-9 relative h-[350px] lg:h-[400px] rounded-[32px] overflow-visible group  p-3">
                 ...
                 <FadeIn delay={0.8} direction="up" className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20">
                    <div className="flex items-center rounded-xl bg-[#04d9ff] pl-2 pr-6 py-3">
                       <div className="flex items-center text-white rounded-full px-3 py-2 mr-4">
                          <div className="flex -space-x-5 items-center">
                             ...
                             <div className="w-10 h-10 rounded-full border-2 border-white overflow-hidden relative flex items-center justify-center bg-black z-10">
                                <span className="text-[#04d9ff] text-xl font-bold">+</span>
                             </div>
                          </div>
                       </div>
                 ...
                 {/* Decorative Stars */}
                 <div className="absolute top-1/2 -translate-y-1/2 -left-6 text-[#04d9ff]">
            ...
            <FadeIn direction="left" delay={0.4} className="lg:col-span-3 bg-[#04d9ff] rounded-4xl p-6 lg:p-8 flex flex-col justify-between h-auto min-h-[350px] lg:h-[400px] hover:shadow-[0_0_30px_rgba(196,255,0,0.2)] transition-shadow duration-300">
                 <div className="space-y-4 lg:space-y-8 mt-2 lg:mt-4">
                    <div className="border-b border-black/10 pb-4 lg:pb-6">
                        <h3 className="text-4xl lg:text-6xl font-bold text-black mb-1">850+</h3>
                        <p className="text-black/60 font-semibold text-sm uppercase tracking-wide">Projects Completed</p>
                    </div>
                     <div className="border-b border-black/10 pb-4 lg:pb-6">
                        <h3 className="text-4xl lg:text-6xl font-bold text-black mb-1">18+</h3>
                        <p className="text-black/60 font-semibold text-sm uppercase tracking-wide">Years of Experience</p>
                    </div>
                 </div>
                 <div className="mt-4 lg:mt-0">
                    <h3 className="text-4xl lg:text-6xl font-bold text-black mb-1">500+</h3>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-[#04d9ff] py-4 overflow-hidden z-20">
