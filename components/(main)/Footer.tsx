      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <FadeIn className="flex flex-col md:flex-row justify-between items-center mb-20 gap-8">
          <h2 className="text-4xl lg:text-5xl font-bold flex items-center gap-3">
            Let&apos;s <span className="text-[#04d9ff]">Connect</span> there
          </h2>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <StaggerItem className="space-y-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#04d9ff] rounded-full flex items-center justify-center">
            ...
            <div className="flex gap-3">
              {[1, 2, 3, 4, 5].map((item) => (
                <div key={item} className="w-8 h-8 bg-[#04d9ff] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition-transform text-black">
          ...
          {/* Navigation Column */}
          <StaggerItem>
            <h3 className="text-[#04d9ff] font-bold mb-6">Navigation</h3>
            <ul className="space-y-4 text-gray-300 text-sm">
              {[
                ...
                <li key={item.name}>
                  <Link href={item.href} className="hover:text-[#04d9ff] transition-colors">
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact Column */}
          <StaggerItem>
            <h3 className="text-[#04d9ff] font-bold mb-6">Contact</h3>
            <ul className="space-y-4 text-gray-300 text-sm">
              <li>+0123-456-789</li>
          ...
          {/* Newsletter Column */}
          <StaggerItem>
            <h3 className="text-[#04d9ff] font-bold mb-6">Get the latest information</h3>
            <div className="relative">
              <input 
                type="email" 
                placeholder="Email address" 
                className="w-full bg-[#1a1a1a] rounded-full py-3 pl-6 pr-14 text-sm focus:outline-none focus:ring-1 focus:ring-[#04d9ff] text-white placeholder-gray-500"
              />
              <button className="absolute right-1 top-1 w-10 h-10 bg-[#04d9ff] rounded-full flex items-center justify-center hover:bg-[#00b8e6] transition-colors">
        ...
        <FadeIn delay={0.4} className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-400">
          <p>Copyright © 2024 <span className="text-[#04d9ff]">Digital Agency</span>. All Rights Reserved.</p>
