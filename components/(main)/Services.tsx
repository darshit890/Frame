...
const services = [
  {
    id: '01',
    title: 'BRANDING',
    image: '/1.png', // Placeholder until user generates new images
    alt: 'Branding workspace setup with orange accents'
  },
  {
    id: '02',
    title: 'UIUX',
    image: '/2.png', // Placeholder
    alt: 'UI/UX design brochure mockup'
  },
  {
    id: '03',
    title: 'PACKAGING',
    image: '/3.png', // Placeholder
    alt: 'Product packaging design interface'
  }
];
