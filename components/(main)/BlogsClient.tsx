                ...
                <FadeIn key={post._id} className="group">
                  ...
                  <div className="flex flex-wrap gap-4 mb-4">
                    {post.categories?.map((cat) => (
                      <span key={cat._id} className="px-4 py-1 rounded-full text-xs font-bold text-black bg-primary">
                        {cat.title}
                      </span>
                    ))}
                    <span className="px-4 py-1 rounded-full text-xs font-bold text-black bg-primary">
                  ...
                  {/* Content */}
                  <h3 className="text-2xl lg:text-3xl font-bold text-black mb-4 leading-tight group-hover:text-primary transition-colors">
                    {post.title}
                  </h3>
                  {post.description && (
                  ...
                  <Link href={`/blog/${post.slug.current}`} className="inline-block text-primary font-bold border-b border-primary hover:text-primary/80 hover:border-primary/80 transition-colors">
                    Read More
                  </Link>
                </FadeIn>
              ))
